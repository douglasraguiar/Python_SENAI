...
try:
    ...
    if hospedes == 1:
        diaria1 = int(input("informe quantos dias ficará hospedado:"))
    elif hospedes == 2:
        diaria1 = int(input("informe quantos dias o hospede 1 ficará hospedado:"))
        diaria2 = int(input("informe quantos dias o hospede 2 ficará hospedado:"))
    elif hospedes == 3:
        diaria1 = int(input("informe quantos dias o hospede 1 ficará hospedado:"))
        diaria2 = int(input("informe quantos dias o hospede 2 ficará hospedado:"))
        diaria3 = int(input("informe quantos dias o hospede 3 ficará hospedado:"))
