...
if hospedes == 1:
    ...
    print(f"""
          ...
          Nome do hospede: {nome}
          Idade do hospede: {idade}
...
if hospedes == 1:
    ...
    Hospede: {nome1}
    Quarto: {quarto1}
    Valor do Quarto: {quarto1_valor}
    Diárias: {diaria1}
    Valor Total {cliente1}
    ...
    Hospede: {nome2}
    Quarto: {quarto2}
    Valor do Quarto: {quarto2_valor}
    Diárias: {diaria2}
    Valor Total {cliente2}
    ...
    Hospede: {nome3}
    Quarto: {quarto3}
    Valor do Quarto: {quarto3_valor}
    Diárias: {diaria3}
    Valor Total {cliente3}
